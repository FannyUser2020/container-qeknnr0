...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qeknnr0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qeknnr0.containers.anotherwebservice.com/
...
```
git clone git@github.com:FannyUser2020/container-qeknnr0.git
cd container-qeknnr0
```
...
```
docker attach container-qeknnr0
```
